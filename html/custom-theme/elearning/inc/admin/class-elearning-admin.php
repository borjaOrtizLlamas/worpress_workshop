...
class eLearning_Admin {
	...
	public static function btn_text( $for_js = true ) {
		...
		$tdi = 'themegrill-demo-importer/themegrill-demo-importer.php';
	...
	public function enqueue_scripts() {
		...
		$welcome_data = array(
			'uri'      => esc_url( admin_url( '/themes.php?page=demo-importer&browse=all&elearning-hide-notice=welcome' ) ),
			'btn_text' => self::btn_text(),
			'nonce'    => wp_create_nonce( 'elearning_demo_import_nonce' ),
		);
