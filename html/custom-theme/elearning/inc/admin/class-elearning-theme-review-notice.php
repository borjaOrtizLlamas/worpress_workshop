		...
		<div class="notice notice-success elearning-notice theme-review-notice" style="position:relative;">
			<div class="elearning-message__content">
				<div class="elearning-message__image">
					<img class="elearning-logo--png" src="<?php echo esc_url( get_template_directory_uri() . '/inc/admin/images/elearning-logo-square.png' ); ?>" alt="<?php esc_attr_e( 'elearning Logo', 'elearning' ); ?>" />
				</div>
